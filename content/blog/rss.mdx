...
script run outside of my normal website code. I'm using Typescript, and apparently
`ts-node`, the tool to run Typescript files, doesn't support modules. Writing the script in
Javascript wasn't really an option for me because I wanted to reuse a lot of logic that I already
wrote for reading and parsing MDX files in the website itself.
