---
title: 'Setting up multiple AWS acounts for fun nor profit'
...
our product _from scratch_. I deployed _everything_ I built into **a single AWS account**.
...
structure. It will let you manage all those accounts from one central _management account_. All
bills from all member accounts will be aggregated to the management account where you can pay them
as one.
