...
When playing around with Spark on my [local, virtual cluster](/archive/installing-virtual-hadoop-cluster), I ran into some problems concerning resources, even though I had 3 _workers_ running on 3 nodes. I got the following message repeatedly while working with data in the `spark-shell`:
