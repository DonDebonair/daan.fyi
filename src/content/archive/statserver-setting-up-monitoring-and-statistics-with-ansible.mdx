...
```bash
$ echo "192.168.33.30 graphite.local" >> /etc/hosts
$ echo "192.168.33.30 sentry.local" >> /etc/hosts
$ vagrant up
```
...
If you look at my Github repos and/or blog, you'll notice [my efforts](https://github.com/DandyDev/sentry-vagrant) in [doing something similar](/archive-assetssetting-up-sentry-using-vagrant-and-puppet.md) with only Sentry, using Puppet. So why did I choose Ansible now?
...
![graphite-graph.png](/archive-assets/images/graphite-graph.png)
